...
problémov, ktoré sa vyskytli pri realizácií tejto práce.  V neposlednom rade sa
chcem poďakovať svojej ostatnej rodine, ktorá svojimi postojmi prispela k
vytvoreniu priaznivých podmienok pre vznik mojej diplomovej práce.}
