%% diplomovka.tex
%% Copyright 2016, 2017, 2018  Juraj Szasz <juraj.szasz3@gmail.com>
%
...
\TemaPrace{Scientometrická analýza FPV~UCM v~Trnave}{Scientometrická analýza
  Fakulty prírodných vied Univerzity sv.~Cyrila a~Metoda
  v~Trnave}{Scientometric analysis of the Faculty of Natural Sciences,
...
\TextAbstraktov{Scientometrická analýza slúži na kvalitatívne a~kvantitatívne
  ...
  a~prínos pre vedecký pokrok.  Cieľom tejto práce je kvalitatívne a~kvantitatívne
...
\TextPodakovania{Ďakujem môjmu školiteľovi prof.~Jánovi Kraicovi, za jeho
  ...
  problémov, ktoré sa vyskytli pri realizácii tejto práce.  V~neposlednom rade
  sa chcem poďakovať svojej ostatnej rodine, ktorá svojimi postojmi prispela
...
% Umozni zalamovanie dlhych linkov v \url
\makeatletter
\g@addto@macro{\UrlBreaks}{\UrlOrds}
\makeatother

% Zabrani preteceniu poznamky pod ciarou na dalsiu stranu
\interfootnotelinepenalty=10000

% Definovanie správneho delenia slov pre problematické slová
\hyphenation{citač-ných}
\hyphenation{naj-väčšie-mu}
