...
teda meranie\,--\,doslovne \uv{meranie poznania.} Pojem scientometria \cite{Nalimov1969} definoval ako kvantitatívne metódy, ktoré sú používané na analýzu
...
gigantu \emph{Thomson Reuters} so sídlom New Yorku, USA. \citep{Drake2005}
...
Prvý citačný indikátor navrhol zakladateľ citačných registrov \citet{Garflield1955}
ako presnejší spôsob evaluácie autorov vedeckých článkov než v~tej dobe
