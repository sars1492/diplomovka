...
\textporson{biblion}\index{biblion@\textporson{biblion}}, kniha,
a~\textporson{métron}\index{métron@\textporson{métron}}, meranie.  Doslovný
preklad tohto termínu by teda znel \uv{meranie kníh}, prípadne \uv{veda zaoberajúca sa meraním kníh}.
...
Najčastejšou bibliometrickou metódou je tzv.~citačná analýza\index{citačná
...
dokumentov v~databázach (ang.~\uv{\foreignlanguage{english}{related documents search}}), ktoré je niekedy
nazývané ako \uv{\foreignlanguage{english}{pattern search}}, tzv.~vzorové vyhľadávanie.  Vyhľadávacie
...
v~texte knihy Odysseus\footnote{ang. \emph{Ulysses} -- známy román írskeho spisovateľa Jamesa Joycea}.  \citet{Powers1998} uvádza, že Zipf
...
Web of Science (ďalej len WoS) je online platená služba umožňujúca
...
\footnote{\url{http://wokinfo.com/citationconnection/realfacts}}  Keďže
...
Jadro databázy k~januáru 2016 obsahuje viac než 60 miliónov záznamov%
...
bibliografické záznamy z~databázy GS.  Na rozdiel od WoS a~Scopusu, ktoré
...
45, 12, 5 a~2), jeho Hirshov index je rovnaký ako u \emph{vedca A}.

Sám Hirsh uvádza, že $h$-index nemožno použiť na porovnávanie autorov rôznych
vedných disciplín.
