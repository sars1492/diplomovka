...
V stĺpcoch $P$ a $c$ uvádzame sumu všetkých článkov a citácií v dátom súbore.
Tieto informácie uvádzame pre ilustráciu, pretože Veľkosti dátových súborov, z
ktorých dane indikátory boli počítané, určujú presnosť štatistiky. 
...
prípadoch (najmä pre hodnoty indexov dokumenty na autora a citácie na dokument)
...
Tabuľka \ref{tab:2-staff.results} obsahuje počet citácií na dokument a Zhangov
$e$-index.  Keď porovnáme hodnoty štandartných odchýlok a hodnoty aritmetických
...
vidieť, že mediány $e$-indexu sú rádovo väčšie od ostatných (Graficky znáznornené
na Obrázku \ref{fig:e-index.results}).

\citet{Kazakis2015} scientometricky analyzoval katedry 
