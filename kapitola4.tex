...
a~jeho variantu pre program Publish or Perish
...
(\emph{viď}~\nameref{chap:appendix}).  Tabuľka zahrňuje najpoužívanejšie citačné
...
\begin{table}
  ...
  {Scientometrické hodnotenie katedier Fakulty prírodných vied UCM v~Trnave -- $h^{\mathrm{c}}$-index a $h_{\mathrm{m}}$-index.}
