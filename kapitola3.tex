...
bola ich nedávna zmena mena po svadbe (viď Tabuľka \ref{tab:staff.rename} Našťastie
...
\centering\small
  ...
  pracovníkov FPV, u~ktorých došlo k~zmene priezivska. Pôvodné priezivsko sme
...
v~Prílohe.  V~prípade ak citačný indikátor pre daný časopis sa nám nepodarilo vyhľadať, tak sme položku
v~zozname označili pomlčkou.
...
\begin{tabular}{ll}
  ...
  SNIP                            & {\footnotesize \url{http://www.scimagojr.com}} \\[0.5ex]
  \bottomrule
\end{tabular}
\end{SCtable}
