...
Bibliografické záznamy FPV UCM sme získali z~citačných registrov WoS a Scopus dňa
...
pretože v~publikáciách sa vyskytujú rôzne varianty názvu univerzity (napr.\,SS~Cyril \& Methodius Trnava, alebo Sv.\,Cyril and Methodius Trnava).  Aby sme
...
variantom mena (napr.\,s~diakritikou, bez diakritiky, s~krstným menom, iniciálami).
...
vložiť do poľa \uv{všetky slová} (ang.\,\emph{All of the words}) reťazce, ktoré
...
formátov ako napr.\,CSV, MS Excel, EndNote\footnote{\url{http://endnote.com/}}, a
BibTeX\footnote{\url{http://www.bibtex.org/}}.  PoP umožňuje scientometrickú
